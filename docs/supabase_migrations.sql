-- =============================================
-- MIGRATIONS DO GRENFLOW PARA SUPABASE
-- =============================================
...
-- Tabela de Empresas (Geradores e Operadores)
...
-- Tabela de MTRs (Manifesto de Transporte de Resíduos)
...
-- Tabela de CDFs (Certificado de Destinação Final)
...
-- =============================================
-- 2. ÍNDICES PARA OTIMIZAR CONSULTAS
-- =============================================
...
-- =============================================
-- 3. RLS (Row Level Security) - POLÍTICAS DE ACESSO
-- =============================================
...
-- Políticas para MTRs (apenas gerador e operador envolvidos)
...
DECLARE
  ...
  mtr_number TEXT;
BEGIN
  -- Obter código da empresa (primeiras 3 letras do nome)
